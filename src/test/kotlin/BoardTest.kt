...
internal class BoardTest {
    ...
    fun setUp() {
        ...
        board = Board(10, redirectionConfigs, RedirectingEntityFactory())
    }

    @Test
    internal fun `should find next position`() {
        val currPosition = Square(3)
